...
Adventure sports aren't just about the thrill—they're about discovering what you're truly capable of.`,
    metaTitle: "Ultimate Adventure Sports Destinations for Thrill Seekers in 2026",
    metaDescription: "From paragliding in the Swiss Alps to surfing in Bali, discover the world's most exciting adventure sports destinations.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4",
    tags: ["Adventure", "Sports", "Travel", "Extreme Sports"],
    readTime: "16 min"
  },
  {
...
These cities offer what mass tourism can't—genuine connections with locals and undiscovered treasures.`,
    metaTitle: "Hidden European Gems: 10 Underrated Cities to Visit in 2026",
    metaDescription: "Skip the tourist crowds and discover Europe's best-kept secrets—from medieval towns to coastal paradises.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1499856871958-5b9627545d1a",
    tags: ["Europe", "Hidden Gems", "Cities", "Off the Beaten Path"],
    readTime: "22 min"
  },
  {
...
Sustainable packing isn't about perfection—it's about making better choices, one trip at a time.`,
    metaTitle: "The Sustainable Traveler's Packing Guide for 2026",
    metaDescription: "Essential eco-friendly gear and packing tips to minimize your environmental footprint while traveling.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9",
    tags: ["Sustainability", "Packing", "Eco-Travel", "Zero Waste"],
    readTime: "18 min"
  },
  {
...
Southeast Asia proves that the best travel experiences have nothing to do with how much you spend.`,
    metaTitle: "The Complete Budget Backpacking Guide to Southeast Asia 2026",
    metaDescription: "Travel Southeast Asia for under $30 a day—accommodation, food, transport, and activities included.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a",
    tags: ["Budget Travel", "Backpacking", "Southeast Asia", "Money Saving"],
    readTime: "24 min"
  },
  {
...
These journeys prove that sometimes the old way is still the best way.`,
    metaTitle: "The World's Most Spectacular Luxury Train Journeys in 2026",
    metaDescription: "Experience the golden age of rail travel with these opulent train journeys across continents.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1474487548417-781cb71495f3",
    tags: ["Luxury Travel", "Train Journeys", "Railways", "Slow Travel"],
    readTime: "20 min"
  },
  {
...
Children who travel learn empathy, adaptability, and curiosity—lessons that last a lifetime.`,
    metaTitle: "Stress-Free Family Travel: Expert Tips for 2026 Adventures",
    metaDescription: "Everything you need to know about traveling with kids—from packing hacks to destination recommendations.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1",
    tags: ["Family Travel", "Kids", "Parenting", "Travel Tips"],
    readTime: "19 min"
  },
  {
...
Every professional was once a beginner. Take 1,000 photos, keep 10, and learn from the rest.`,
    metaTitle: "Mastering Travel Photography Composition in 2026",
    metaDescription: "Learn the essential composition techniques that will transform your travel photos from snapshots to stunning imagery.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1452587925148-ce544e77e70d",
    tags: ["Photography", "Composition", "Travel Tips", "Visual Arts"],
    readTime: "17 min"
  },
  {
...
Sakura reminds us that beauty is temporary—and that's what makes it precious.`,
    metaTitle: "The Ultimate Japan Cherry Blossom Guide for 2026",
    metaDescription: "Timing, locations, and insider tips for experiencing Japan's most magical season—sakura season.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1522383225653-ed111181a951",
    tags: ["Japan", "Cherry Blossoms", "Sakura", "Spring Travel"],
    readTime: "21 min"
  },
  {
...
Proper tax planning isn't optional—it's the foundation of a sustainable nomadic lifestyle.`,
    metaTitle: "The Digital Nomad Tax Guide: Navigating International Tax Laws in 2026",
    metaDescription: "Essential tax strategies for remote workers living abroad—residency rules, tax treaties, and legal structures.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1554224311-beee2f490c20",
    tags: ["Digital Nomad", "Tax", "Remote Work", "Legal"],
    readTime: "23 min"
  },
  {
...
Your safari dollars fund anti-poaching units and community development. You're not just a tourist—you're a conservationist.`,
    metaTitle: "The Ultimate Wildlife Safari Guide: Africa's Best Parks in 2026",
    metaDescription: "From the Serengeti migration to mountain gorilla trekking—plan your dream African safari.",
    locale: "en",
    imageUrl: "https://images.unsplash.com/photo-1516426122078-c23e76319801",
    tags: ["Safari", "Wildlife", "Africa", "Adventure", "Conservation"],
    readTime: "25 min"
  }
];
...
async function importArticles() {
  try {
    console.log('Starting import of 10 new articles...');
    ...
    for (const article of articles) {
      ...
      while (retries > 0 && !success) {
        try {
          console.log(`Importing: ${article.title} (${retries} attempts left)`);
          ...
          retries--;
          console.log(`  Retry ${3 - retries}/3 failed for ${article.slug}`);
          if (retries > 0) {
            await new Promise(resolve => setTimeout(resolve, 2000));
          } else {
            console.error(`  Failed to import ${article.slug}:`, err);
          }
        }
      }
    }
    
    console.log(`\n✅ Successfully imported ${successCount}/${articles.length} articles!`);
